...
class HttpLexer(RegexLexer):
    ...
    def header_callback(self, match):
        ...
        yield match._start(1), Name.Attribute, match.group(1)
        yield match._start(2), Text, match.group(2)
        yield match._start(3), Operator, match.group(3)
        yield match._start(4), Text, match.group(4)
        yield match._start(5), Literal, match.group(5)
        yield match._start(6), Text, match.group(6)

    def continuous_header_callback(self, match):
        yield match._start(1), Text, match.group(1)
        yield match._start(2), Literal, match.group(2)
