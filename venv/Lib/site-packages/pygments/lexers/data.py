...
class YamlLexer(ExtendedRegexLexer):
    ...
    def something(token_class):
        ...
        def callback(lexer, match, context):
            ...
            if not text:
                return
            yield match._start(), token_class, text
    ...
    def save_indent(token_class, start=False):
        ...
        def callback(lexer, match, context):
            ...
            if text:
                yield match._start(), token_class, text
            if extra:
                yield match._start() + len(text), token_class.Error, extra
            context.pos = match.end()
        return callback
    ...
    def parse_block_scalar_empty_line(indent_token_class, content_token_class):
        ...
        def callback(lexer, match, context):
            ...
            if (context.block_scalar_indent is None or
                ...
                if text:
                    yield match._start(), indent_token_class, text
            else:
                indentation = text[:context.block_scalar_indent]
                content = text[context.block_scalar_indent:]
                yield match._start(), indent_token_class, indentation
                yield (match._start() + context.block_scalar_indent,
