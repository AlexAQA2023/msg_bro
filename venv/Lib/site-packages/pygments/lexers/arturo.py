...
class ArturoLexer(RegexLexer):
    ...
    def handle_annotated_strings(self, match):
        ...
        # Header's section
        yield match._start(1), String.Double,   match.group(1)
        yield match._start(2), String.Interpol, match.group(2)
        yield match._start(3), String.Interpol, match.group(3)
        yield match._start(4), Text.Whitespace, match.group(4)
        ...
        yield match._start(6), String.Double, match.group(6)
