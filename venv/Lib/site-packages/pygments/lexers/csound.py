...
class CsoundOrchestraLexer(CsoundLexer):
    ...
    def opcode_name_callback(lexer, match):
        ...
        yield match._start(), Name.Function, opcode
    ...
    def name_callback(lexer, match):
        ...
        if name in OPCODES or name in DEPRECATED_OPCODES or name in REMOVED_OPCODES:
            yield match._start(), Name.Builtin, name
        elif name in lexer.user_defined_opcodes:
            yield match._start(), Name.Function, name
        else:
            ...
            if name_match:
                ...
                yield match._start(), Name, name

        if match.group(2):
            yield match._start(2), Punctuation, match.group(2)
            yield match._start(3), type_annotation_token, match.group(3)
