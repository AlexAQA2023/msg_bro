...
class peekable:
    ...
    def _get_slice(self, index):
        ...
        if step > 0:
            start = 0 if (index._start is None) else index._start
            stop = maxsize if (index._stop is None) else index._stop
        elif step < 0:
            start = -1 if (index._start is None) else index._start
            stop = (-maxsize - 1) if (index._stop is None) else index._stop
        else:
